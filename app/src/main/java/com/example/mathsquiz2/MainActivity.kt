...
class MainActivity : AppCompatActivity() {
    ...
    //add shared preference for high score
    private lateinit var sharedPreferences: SharedPreferences
    private var highScore: Int
        get() = sharedPreferences.getInt(HIGH_SCORE_KEY, 0)
        set(value) = sharedPreferences.edit().putInt(HIGH_SCORE_KEY, value).apply()
    ...
    private fun startGame() {
        ...
        //dash board eka ain wela methant game ek enw
    ...
    private fun endGame() {
        ...
        val message = if (score > highScore) {
            highScore = score
